...
public class MDKeywordsTypeSDN<X>
        //extends MDKeywordsType
        implements Serializable {

    @XmlElement(required = true, namespace = "http://www.isotc211.org/2005/gmd")
    protected List<X> keyword;
    @XmlElement(required = true, namespace = "http://www.isotc211.org/2005/gmd")
     ...
     *
     */
    public List<X> getKeyword() {
        if (keyword == null) {
            keyword = new ArrayList<X>();
        }
        return this.keyword;
    }
     ...
     *
     * @param value allowed object is {@link MDKeywordTypeCodePropertyType }
     *
     */
