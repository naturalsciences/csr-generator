...
<!-- 
    ...
    *
    * schematron rules version 5.0.0
    */
-->
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron">
    ...
    <sch:pattern>
        <sch:title>aggregationInfo (35.1) -> mandatory; restricted cardinality</sch:title>
        <sch:rule context="gmd:MD_DataIdentification | sdn:SDN_DataIdentification">            
            <sch:assert test="gmd:aggregationInfo">aggregationInfo missing</sch:assert>
            <sch:assert test="count(gmd:aggregationInfo) &lt; 3">aggregationInfo cardinality differs from 0/1/2</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmd:MD_Resolution">            
            ...
            <sch:assert test="$catalog//skos:externalID[substring(.,string-length(.) - $length + 1,$length) = $uomValue]">the given uomValue is not included in P06 list</sch:assert>            
        </sch:rule>
    </sch:pattern>
        
    <!-- Aggregation information -->
    <sch:pattern>
        <sch:title>aggregateDataSetName (66.2) -> mandatory; restricted domain</sch:title>
        <sch:rule context="gmd:MD_AggregateInformation">            
            <sch:assert test="gmd:aggregateDataSetName">aggregateDataSetName missing</sch:assert>
            <sch:assert test="gmd:aggregateDataSetName/gmd:CI_Citation/gmd:title">title missing</sch:assert>
            <sch:assert test="gmd:aggregateDataSetName/gmd:CI_Citation/gmd:alternateTitle">alternateTitle missing</sch:assert>
            <sch:assert test="gmd:aggregateDataSetName/gmd:CI_Citation/gmd:date">date missing</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmd:MD_Identifier">            
            <sch:assert test="gmd:code/gco:CharacterString">CharacterString missing</sch:assert>
        </sch:rule>
    </sch:pattern>
    <sch:pattern>
        <sch:title>code (207) -> restricted domain</sch:title>
    ...
    <sch:pattern>
        ...
        <sch:rule context="gmd:EX_VerticalExtent">
            ...
            <sch:assert test="$catalog//skos:externalID[substring(.,string-length(.) - $length + 1,$length) = $identifierValue]">the given vertical datum identifier is not included in L11 list</sch:assert>
    ...
    <sch:pattern>
        ...
        <sch:rule context="*">            
            <sch:assert test="node() or @gco:nilReason">null objects are not permitted unless for optional elements - in that case a reason for the null must be provided</sch:assert>
        </sch:rule>
    </sch:pattern>
